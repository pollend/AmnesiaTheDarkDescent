...
namespace hpl
{
    ...
    absl::Span<char> Buffer::GetBuffer()
    {
        ...
        return absl::Span<char>(reinterpret_cast<char*>(m_memory->data), m_memory->size);
    }
    ...
    absl::Span<const char> Buffer::GetBuffer() const
    {
        ...
        return absl::Span<const char>(reinterpret_cast<const char*>(m_memory->data), m_memory->size);
    }
    ...
    void Buffer::GetAttribute(float output[4], size_t offset, bgfx::Attrib::Enum attribute)
    {
        ...
        bgfx::vertexUnpack(output, attribute, _definition.m_layout, m_memory->data, offset);
    }
    ...
    void Buffer::SetAttribute(const float data[4], size_t offset, bool normalized, bgfx::Attrib::Enum attribute)
    {
        ...
        bgfx::vertexPack(data, normalized, attribute, _definition.m_layout, m_memory->data, offset);
    }
