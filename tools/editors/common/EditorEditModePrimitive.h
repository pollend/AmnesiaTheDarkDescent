...
public:
	...
	virtual void Draw(cEditorWindowViewport* apViewport, DebugDraw* apFunctions, const cVector3f& avPos)=0;
...
public:
	...
	void Draw(cEditorWindowViewport* apViewport, DebugDraw* apFunctions, const cVector3f& avPos);
