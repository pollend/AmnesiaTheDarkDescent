...
#ifndef HPLEDITOR_EDITOR_EDIT_MODE_JOINTS_H
#define HPLEDITOR_EDITOR_EDIT_MODE_JOINTS_H
...
class cEditorEditModeJoints : public iEditorEditModeObjectCreator
{
public:
	cEditorEditModeJoints(iEditorBase* apEditor,
...
#endif // HPLEDITOR_EDITOR_EDIT_MODE_JOINTS_H
