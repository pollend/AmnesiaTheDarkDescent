...
#ifndef HPLEDITOR_EDITOR_EDIT_MODE_PARTICLE_SYSTEMS_H
#define HPLEDITOR_EDITOR_EDIT_MODE_PARTICLE_SYSTEMS_H
...
class cEditorEditModeParticleSystems : public iEditorEditModeObjectCreator
{
public:
...
#endif // HPLEDITOR_EDITOR_EDIT_MODE_PARTICLE_SYSTEMS_H
